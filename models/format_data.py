...
train = ['../processed_data/nl/spacy-sm/processed_nes_data/corp.pkl','../processed_data/nl/spacy-sm/processed_nes_data/equi.pkl','../processed_data/nl/spacy-sm/processed_nes_data/wind.pkl']
...
final_train_df.to_csv('../processed_data/nl//spacy-lg/processed_nes_data/train.csv', index=False)